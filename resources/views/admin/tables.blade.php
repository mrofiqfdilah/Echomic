        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <form action="{{ route('admin.search') }}" method="GET" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                        <div class="input-group">
                            <input type="text" name="search" class="form-control bg-light border-0 small" placeholder="Cari users" aria-label="Search" aria-describedby="basic-addon2">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Menampilkan data users yang telah register, sebagai admin dapat Menambah users , hapus dan edit users , Cari Users dan Print data.</p>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Dashboard / Data Users</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                             <a href="{{ route('admin.create') }}" class="btn btn-primary mb-3">Tambah data</a>
                 <!-- In your admin.tables.blade.php or any other relevant view -->
<a href="{{ route('admin.pdf') }}" class="btn btn-danger mb-3" style="margin-left: 10px;">Print PDF</a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Echomic 2024</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
