...
<head>
    ...
    <title>Echomic | Komik Disimpan</title>
...
<header class="header">
    ...
    <div class="header-1">
        ...
        <div class="icons">
            <a href="#" style="color:#27ae60;" class="fas fa-bookmark"></a>
...
<section class="sim">
    <p class="daftar-vol">Daftar Simpan</p>
    <p class="desk-vol">
            Berikut adalah komik yang anda simpan , anda juga dapat menghapus komik yang anda simpan.
    </p>
    @if ($simpankomiks->count() > 0)
        <div class="box-container">
            @foreach($simpankomiks as $simpankomik)
                <div class="bo3x">
                   <img class="gambar" src="{{ $simpankomik->komik->cover_komik }}" alt="">
                   <p class="judulkom">{{ $simpankomik->komik->judul_komik }}</p>
                   <p class="volumekom">Volume {{ $simpankomik->volume->judul_volume }}</p>
                   <button class="tombol"><a href="{{ route('bacakomik', ['id' => $simpankomik->komik->id, 'volume' => $simpankomik->volume->id]) }}" class="baca-sekarang">Baca Sekarang</a>
                 </button>
    
            
                 <a href="{{ route('delete_simpankomik', ['id' => $simpankomik->id]) }}" class="x hapus-komik"><i class="ri-close-fill"></i></a>
        ...
        <p class="anda">Anda belum menyimpan komik!</p>
    </div>
        @endif
</section>
