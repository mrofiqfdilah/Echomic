        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Search -->
                    <form action="{{ route('carikomikauthor') }}" method="GET" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Menampilkan data komik yang anda buat , anda dapat Menambah Komik serta hapus dan edit Komik.</p>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                             <a href="{{ route('author.halaman_tambahkomik') }}" class="btn btn-primary mb-3">Tambah data</a>
                             <a href="{{ route('author.comic_pdf') }}" class="btn btn-danger mb-3" style="margin-left: 10px;">Print PDF</a>
                                    ...
                                    <thead>
                                        ...
                                        <tbody>
                                            ...
                                            <td  style="text-align: center;">
                                                <a style="text-decoration: underline;" href="{{ route('author.halaman_datavolume', ['komik_id' => $komik->id]) }}">Cek Volume </a>
                                            </td>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center"> <!-- Edit button -->
                                                    <a href="{{ route('author.edit', $komik->id) }}" class="btn btn-primary">Edit</a>
                                                    <!-- Delete button -->
                                                    <form action="{{ route('author.destroy', $komik->id) }}" method="post" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?')">
                                                        @csrf
                                                        @method('DELETE')
