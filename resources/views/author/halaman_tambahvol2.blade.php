...
<head>
    ...
    <title>Author | Tambah Volume</title>
...
<body>
    <div class="container mt-5">
        <div class="card">
            <div class="card-body">
                <p>Form Tambah Volume</p>
        <form action="{{ route('author.tambahvolumeauthor') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="komik_id" value="{{ $komik->id}}" class="form-control mb-3">
            ...
            <div class="mb-4" id="gambar-container">
                <label for="gambar" class="form-label">Gambar Komik (Upload for each page)</label>
